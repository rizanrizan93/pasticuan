...
def check_version_contract() -> None:
    ...
    assert eng.ENGINE_VERSION == '9.7.3'
    assert rs.RESUMABLE_SCAN_VERSION == '9.7.3'
    app_source = (ROOT / 'app.py').read_text(encoding='utf-8')
    assert 'APP_VERSION = "9.7.3-staged-performance"' in app_source
