...
APP_VERSION = "9.8.4-calibration-integrity"
APP_ROOT = Path(__file__).resolve().parent
if str(APP_ROOT) not in sys.path:
    sys.path.insert(0, str(APP_ROOT))

st.set_page_config(page_title="IDX Scanner v9.8.4", page_icon="📊", layout="wide")
...
if missing:
    st.error("Deployment v9.8.4 tidak lengkap.")
...
st.title("IDX Super Scanner v9.8.4 — Calibration Integrity")
st.caption(
