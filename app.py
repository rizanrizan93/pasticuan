...
st.set_page_config(page_title="IDX Super Scanner Signal Calibration v4.7.0", page_icon="🎯", layout="wide")
...
st.title("IDX Super Scanner — Signal Calibration v4.7.0")
...
if "scan_result" not in st.session_state:
    st.markdown(
        ...
        <div class="scanner-note">
          <b>Alur otomatis v4.7.0 Signal Calibration</b><br>
...
with tab_method:
    st.markdown(
        """
        ### Hirarki sinyal v4.7.0 Signal Calibration
