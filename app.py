...
APP_VERSION = "9.8.2-hotfix8-fundamental-period-integrity"
...
st.title("IDX Super Scanner v9.8.2 Hotfix 8 — Fundamental Period Integrity")
st.caption(
...
with dashboard_tab:
    ...
    top_leader_tab, top_swing_tab = st.tabs(["Top 3 Next Leader", "Top 3 Swing / Watch"])
    with top_leader_tab:
...
with leader_tab:
    columns = [
        "rank", "production_rank", "ticker", "sector", "candidate_type", "thesis_archetype", "status",
...
with swing_tab:
    columns = [
        "rank", "production_rank", "ticker", "sector", "status", "Ranking Score", "Production Score",
