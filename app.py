...
st.set_page_config(page_title="IDX Super Scanner Decision Dashboard v6.6.6", page_icon="🛡️", layout="wide")
...
st.title("IDX Super Scanner — Best Buy & EOFF Top-20 v6.6.6")
...
if "scan_result" not in st.session_state:
    st.markdown(
        ...
        <div class="scanner-note">
          <b>Alur otomatis v6.6.6 Provider Guard Batch 2</b><br>
...
with main_existing:
    ...
    with tab_method:
        st.markdown(
            """
            ### Hirarki sinyal v6.6.6 Best Buy & EOFF Top-20
