...
st.set_page_config(page_title="IDX Multibagger & Core Swing Scanner v7.1.0", page_icon="🛡️", layout="wide")
...
st.title("IDX Scanner — Multibagger & Core Swing v7.1.0")
...
if run_scan and uploaded is not None:
    ...
    result.update({
        ...
        "scanner_version": "7.1.0-event-aware-research-memory",
    })
