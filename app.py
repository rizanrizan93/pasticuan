...
st.set_page_config(page_title="IDX Super Scanner Validated Hybrid AI v6.2.0", page_icon="🛡️", layout="wide")
...
REQUIRED_SCANNER_FILES = ("scanner.py", "scanner_specialty.py", "ai_engine.py")
...
st.title("IDX Super Scanner — Validated Hybrid AI v6.2.0")
...
if "scan_result" not in st.session_state:
    st.markdown(
        ...
        <div class="scanner-note">
          <b>Alur otomatis v6.2.0 Validated Hybrid AI</b><br>
...
with tab_orders:
    ...
    st.caption(
        ...
        "dan outcome memory. Bobot AI otomatis diturunkan saat sampel lemah, kalibrasi buruk, atau terjadi feature drift; bukan jaminan profit."
    )
...
with tab_multibagger:
    ...
    st.caption(
        ...
        "integritas data, momentum, smart-money proxy, kualitas pipeline proyek, dan rekam jejak manajemen. "
...
with tab_method:
    st.markdown(
        """
        ### Hirarki sinyal v6.2.0 Validated Hybrid AI
