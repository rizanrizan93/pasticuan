...
st.set_page_config(page_title="IDX Super Scanner Decision Dashboard v6.6.3", page_icon="🛡️", layout="wide")
...
from dashboard_v660 import (
    DASHBOARD_VERSION, build_top15_ranking, render_top15_dashboard, render_time_cycle_main_tab,
)
...
def run_single_ticker_deep_dive(
    ...
    *,
    ...
    ranking = build_top15_ranking(detail_result, limit=5)
...
st.title("IDX Super Scanner — Three-Tab Decision Dashboard v6.6.3")
...
if "scan_result" not in st.session_state:
    st.markdown(
        ...
        <div class="scanner-note">
          <b>Alur otomatis v6.6.3 Three-Tab Decision Dashboard</b><br>
          1) Tab 1 dan Tab 3 dapat membedah ticker tanpa CSV.<br>
          2) Upload universe ticker untuk membangun Top 15 lintas pasar dan Dashboard Lengkap.<br>
...
with main_existing:
    ...
    with tab_method:
        st.markdown(
            """
            ### Hirarki sinyal v6.6.3 Three-Tab Decision Dashboard
