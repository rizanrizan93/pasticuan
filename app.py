...
st.set_page_config(page_title="IDX Super Scanner Resilient v4.2.3", page_icon="🎯", layout="wide")
...
st.title("IDX Super Scanner — Resilient Evidence v4.2.3")
...
with tab_fast:
    ...
    with fast_bsjp:
        ...
        st.warning("Strategi overnight berisiko gap. BSJP_READY hanya dapat muncul pada 14:30–15:49 WIB dengan data intraday 5 menit; di luar waktu itu hasil bersifat watchlist.")
    ...
    with fast_bpjs:
        ...
        st.warning("BPJS adalah day trade. BPJS_READY hanya dapat muncul pada 09:20–10:45 WIB setelah ORB 15 menit, VWAP, opening volume, dan batas gap lulus. Posisi wajib ditutup sebelum market close.")
        st.caption("BPJS_WAIT_OPENING_BARS berarti data 5m sudah masuk tetapi opening range belum memiliki candle konfirmasi. BPJS_DATA_UNAVAILABLE berarti provider intraday benar-benar gagal dan perlu scan ulang.")
