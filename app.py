...
st.set_page_config(page_title="IDX Super Scanner Decision Dashboard v6.6.4", page_icon="🛡️", layout="wide")
...
st.title("IDX Super Scanner — Three-Tab Decision Dashboard v6.6.4")
...
if "scan_result" not in st.session_state:
    st.markdown(
        ...
        <div class="scanner-note">
          <b>Alur otomatis v6.6.4 Three-Tab Decision Dashboard</b><br>
...
with main_existing:
    ...
    with tab_method:
        st.markdown(
            """
            ### Hirarki sinyal v6.6.4 Three-Tab Decision Dashboard
