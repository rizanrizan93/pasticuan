...
def _growth_bundle_from_frames(quarterly_frame: pd.DataFrame, annual_frame: pd.DataFrame, row_names: list[str]) -> dict:
    quarterly_series = _statement_row_series(quarterly_frame, row_names)
    annual_series = _statement_row_series(annual_frame, row_names)
    quarterly_series = _prepare_statement_series(quarterly_series)
    annual_series = _prepare_statement_series(annual_series)
