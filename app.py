...
st.set_page_config(page_title="IDX Super Scanner Modular Clean v5.0.0", page_icon="🎯", layout="wide")
...
st.title("IDX Super Scanner — Modular Clean v5.0.0")
...
if "scan_result" not in st.session_state:
    st.markdown(
        ...
        <div class="scanner-note">
          <b>Alur otomatis v5.0.0 Modular Clean</b><br>
...
with tab_method:
    st.markdown(
        """
        ### Hirarki sinyal v5.0.0 Modular Clean
