...
st.set_page_config(page_title="IDX Super Scanner Resilient v4.3.1", page_icon="🎯", layout="wide")
...
st.title("IDX Super Scanner — Free Multi-Source v4.3.1")
...
if run_scan and uploaded is not None:
    ...
    # Broker-level data is not fabricated. v4.3.1 keeps the quantitative
