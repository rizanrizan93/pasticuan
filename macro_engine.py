...
MACRO_ENGINE_VERSION = "9.0.1-macro-first-transmission-v1"
...
def _build_factor_state(
    ...
    features = {**_benchmark_features(benchmark), **_prepared_breadth(prepared)}
...
def build_macro_regime(
    *,
    ...
    factors, raw = _build_factor_state(benchmark, prepared, macro_series)
