...
DASHBOARD_VERSION = "7.2.0-ihsg-direction-overlay"
CORE_STRATEGIES = {
...
def render_top20_dashboard(
    ...
    st.caption(
        ...
        "Best Buy Date/EOFF hanya informasi timing; IHSG hanya risk cap dan tidak mengubah urutan."
    )
            ...
            try:
                event = st.dataframe(
                    ...
                    column_config={
                        ...
                        "ihsg_risk_budget_pct": st.column_config.NumberColumn("IHSG risk cap", format="%.0f%%"),
                    },
                )
