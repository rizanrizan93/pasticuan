...
class DeploymentManifestTests(unittest.TestCase):
    def test_every_app_imported_scanner_module_is_packaged(self):
        required = [
            "__init__.py", "backtest.py", "charts.py", "config.py", "data.py",
            "engine.py", "fundamentals.py", "indicators.py", "models.py",
            "price_rules.py", "setups.py",
        ]
        missing = [name for name in required if not (ROOT / "scanner" / name).is_file()]
