...
EOFF_VERSION = "6.8.0-objective-time-astro-shadow"
...
def analyze_eoff_reconstruction(
    ...
    *,
    ...
    # Research policy v6.8.0: astronomy remains a shadow diagnostic.
    ...
    validation_path = "OBJECTIVE_FIB_PRICE_FORWARD_VALIDATION" if core_path else "RESEARCH_ONLY_INSUFFICIENT_FORWARD_EVIDENCE"
