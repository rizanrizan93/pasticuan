...
DATABASE_BRIDGE_VERSION = "7.0-v7.5.1"
DATABASE_SCHEMA_VERSION = "scanner_schema_v7"
...
class ScannerDatabaseBridge:
    ...
    def build_payloads(self, result: Mapping[str, Any]) -> dict[str, list[dict[str, Any]]]:
        ...
        model_version = _clean_text(result.get("scanner_version")) or "7.5.1"
        ...
        payloads: dict[str, list[dict[str, Any]]] = {
            ...
            "multibagger_snapshots": _frame_records(multibagger, (
                ...
                "research_eligibility_reason", "portfolio_allocation_eligible",
                "growth_compounder_score", "growth_compounder_base_score",
    ...
    def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                raise
            return self.status_row(
                "HEALTHY_V7_MULTIBAGGER_LANES",
                f"HTTP 200; schema {self.settings.schema}; Multibagger lanes, selector, execution AI, research memory, IHSG outcomes, and calendar hooks ready",
            )
        except Exception as exc:
