...
DATABASE_BRIDGE_VERSION = "5.0-v7.2.0"
DATABASE_SCHEMA_VERSION = "scanner_schema_v5"
...
class ScannerDatabaseBridge:
    ...
    def build_payloads(self, result: Mapping[str, Any]) -> dict[str, list[dict[str, Any]]]:
        ...
        model_version = _clean_text(result.get("scanner_version")) or "7.2.0"
    ...
    def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                raise
            return self.status_row(
                "HEALTHY_V5_IHSG_DIRECTION",
                f"HTTP 200; schema {self.settings.schema}; database-first, research memory, IHSG outcomes, and calendar hooks ready",
            )
        except Exception as exc:
