...
DATABASE_BRIDGE_VERSION = "14.2-batched-checkpoint-transport"
...
class ScannerDatabaseBridge:
    ...
    def _request(
        ...
        **kwargs: Any,
        ...
        attempts = int(self.settings.read_attempts) if retry_safe else 1
        ...
        for checkpoint in checkpoints:
            ...
            if success:
                ...
                record.update({
                    ...
                    "updated_at": now.isoformat(),
                    "model_version": record.get("model_version") or "9.7.2",
                    "schema_version": DATABASE_SCHEMA_VERSION,
                })
            else:
                attempts = int(item.get("attempt_count", 0) or 0)
