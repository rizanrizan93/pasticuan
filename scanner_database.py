...
DATABASE_BRIDGE_VERSION = "13.1-resumable-jobs-heartbeat"
DATABASE_SCHEMA_VERSION = "scanner_schema_v12"
...
class ScannerDatabaseBridge:
    ...
    def complete_scan_job_item(self, item: Mapping[str, Any], result_payload: Mapping[str, Any] | None = None) -> None:
        ...
        record.update({
            ...
            "completed_at": now,
            "updated_at": now,
            "model_version": record.get("model_version") or "9.4.0",
            "schema_version": DATABASE_SCHEMA_VERSION,
        })
