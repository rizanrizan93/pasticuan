...
DATABASE_BRIDGE_VERSION = "14.0-persistent-ohlcv"
DATABASE_SCHEMA_VERSION = "scanner_schema_v13"
...
class DatabaseSettings:
    ...
    def from_env(cls) -> "DatabaseSettings":
        ...
        return cls(
            ...
            timeout_seconds=max(2.0, float(_env_or_streamlit_secret("SCANNER_DATABASE_TIMEOUT", "8"))),
...
class ScannerDatabaseBridge:
    ...
    def complete_scan_job_item(self, item: Mapping[str, Any], result_payload: Mapping[str, Any] | None = None) -> None:
        ...
        record.update({
            ...
            "completed_at": now,
            "updated_at": now,
            "model_version": record.get("model_version") or "9.5.0",
            "schema_version": DATABASE_SCHEMA_VERSION,
        })
