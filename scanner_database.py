...
DATABASE_BRIDGE_VERSION = "10.3-v7.6.4"
DATABASE_SCHEMA_VERSION = "scanner_schema_v10"
...
TABLE_FIELD_TYPES: dict[str, dict[str, set[str]]] = {
    ...
    "selector_snapshots": {
        ...
        "boolean": {"selector_rank_eligible"},
        "json": {"payload"},
        "required": {
            "snapshot_id", "ticker", "as_of", "horizon_bars",
            "model_version", "schema_version",
    ...
    def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            return self.status_row(
                ...
                f"HTTP 200; schema {self.settings.schema}; narrative provenance, lifecycle, directional outcomes, and ranking separation ready",
            )
        except Exception as exc:
