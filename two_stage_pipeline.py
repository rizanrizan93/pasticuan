...
"""Two-stage orchestration helpers for the v8.0.2 production scanner.
...
local/cache-first ranking pass.  Production scores remain owned exclusively by
...
TWO_STAGE_PIPELINE_VERSION = "8.0.2-two-stage-execution-integrity-source-lineage-v2"
...
def build_lightweight_preliminary_focus(
    ...
    *,
    ...
    weight and never replaces the final disjoint score in ``production_scoring``.
