...
SELECTOR_VERSION = "1.3.0-coverage-aware-missing-indicator"
...
def build_cross_sectional_selector(
    ...
    current["swing_selection_score"] = np.round(
        0.44 * horizon_swing + 0.44 * technical + 0.12 * swing_quality,
        1,
    )
    ...
    for column in (
        ...
        value = pd.to_numeric(current[column], errors="coerce").fillna(50.0)
        current[column] = (
