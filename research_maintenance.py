...
"""Research maintenance, calibration, scheduling and outcome memory for v7.6.4.
...
- durable EOFF and Silent Accumulation outcome memory.
"""
...
RESEARCH_MAINTENANCE_VERSION = "7.6.4"
RESEARCH_OUTCOME_SCHEMA_VERSION = "research_outcomes_v1.2"

MODEL_RELEASED_AT = "2026-07-31T00:00:00+00:00"

MODEL_VERSIONS: dict[str, str] = {
    "scanner": "7.6.4",
    "ranking": "7.6.4",
    # v7.6.4 hardens evidence-aware narrative scoring and score-display integrity,
    # while retaining the v7.6.2 atomic trade-plan contract. It does not change
    # the raw fundamental formula. Keep the semantic model stable to avoid forcing
    # every valid v7.5.2 cache row stale again.
    "fundamental": "7.5.2",
    ...
    "stock_selector": "1.4.0-silent-secondary-key",
    "execution_ai": "7.5.0",
    "narrative_engine": "1.2.0",
    "database_schema": "10.0.0",
