...
"""Research maintenance, calibration, scheduling and outcome memory for v7.6.2.
...
RESEARCH_MAINTENANCE_VERSION = "7.6.2"
RESEARCH_OUTCOME_SCHEMA_VERSION = "research_outcomes_v1.2"

MODEL_RELEASED_AT = "2026-07-30T00:00:00+00:00"

MODEL_VERSIONS: dict[str, str] = {
    "scanner": "7.6.2",
    "ranking": "7.6.2",
    # v7.6.2 hardens trade-plan semantics and display integrity, not a raw snapshot
    # fundamental formula. Keep the semantic model stable to avoid forcing
