...
"""Research maintenance, calibration, scheduling and outcome memory for v7.6.1.
...
RESEARCH_MAINTENANCE_VERSION = "7.6.1"
...
MODEL_VERSIONS: dict[str, str] = {
    "scanner": "7.6.1",
    "ranking": "7.6.1",
    # v7.6.1 hardens a point-in-time narrative overlay, not a raw snapshot
