...
"""Research maintenance, calibration, scheduling and outcome memory for v7.1.
...
RESEARCH_MAINTENANCE_VERSION = "7.1.0"
RESEARCH_OUTCOME_SCHEMA_VERSION = "research_outcomes_v1"

MODEL_RELEASED_AT = "2026-07-27T00:00:00+00:00"

MODEL_VERSIONS: dict[str, str] = {
    "scanner": "7.1.0",
    "ranking": "7.1.0",
    "fundamental": "7.1.0",
    "fundamental_parser": "1.1.0",
    "eoff": "7.1.0",
    "time_cycle": "7.1.0",
    "silent_accumulation": "5.0.0",
    "database_schema": "4.0.0",
    "research_outcome": "1.0.0",
}
...
def research_outcome_summary(outcomes: pd.DataFrame | None) -> pd.DataFrame:
    if outcomes is None or outcomes.empty:
        return pd.DataFrame(columns=["signal_family", "liquidity_bucket", "events", "resolved", "hit_rate_pct", "median_return_20d_pct", "median_mfe_pct", "median_mae_pct"])
    rows = []
