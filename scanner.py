...
class ScanConfig:
    ...
    # Legacy v2 defaults; the effective v4.2.4 ScanConfig is defined below.
...
class ScanConfig:
    ...
    # Legacy v3 defaults; the effective v4.2.4 ScanConfig is defined below.
    account_size_idr: float = 10_000_000.0
...
def finalize_execution_integrity(signals: pd.DataFrame, config: ScanConfig | None = None) -> pd.DataFrame:
    ...
    for idx, row in out.iterrows():
        ...
        out.at[idx, "execution_integrity_score"] = confidence
        out.at[idx, "execution_confidence_score"] = confidence
        out.at[idx, "automated_provider_families"] = 3
        out.at[idx, "independent_price_provider_families"] = 1
        out.at[idx, "price_cross_validation_state"] = "SINGLE_PROVIDER_FAMILY"
        out.at[idx, "critical_gate_pass"] = not bool(critical)
