    ...
    def scan(self, histories: dict[str, pd.DataFrame], benchmark: pd.DataFrame | None=None) -> dict[str, Any]:
        ...
        for ticker, frame in prepared.items():
            ...
            universe_rows.append({
                ...
                'status': best['status'],
                # A detector's partial diagnostic score is useful for research,
                # but must never be presented as a live setup quality grade.
...
__version__ = '7.13.0-currency-split-aware-valuation-lineage'
