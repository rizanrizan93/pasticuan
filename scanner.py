...
def _intraday_metrics(frame: pd.DataFrame) -> dict[str, Any]:
    ...
    data_state = "LIVE_READY" if post_orb_bars >= 1 else "OPENING_RANGE_FORMING"
...
__version__ = "4.2.3-bpjs-5m-orb-hotfix"
__all__ = list(dict.fromkeys(__all__ + [
